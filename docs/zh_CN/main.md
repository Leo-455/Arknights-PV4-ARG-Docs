...
不久之后网站进行了更新，此时再登陆只会显示一条消息，意为：正确，但你并没有将它们全部找出来，你是猜的。此外，登陆界面多出来了一行“忘记密码”选项，点击后会提示“如何判断一颗星星是在靠近还是远离我”。大家很快就想到了红移与蓝移，即多普勒效应，但一直没有搞清楚密码是如何得出的。不久之后，F组发布谜题梳理，给出了他们解出密码的过程。将PV4 1:43处的光点视为摩尔斯电码，蓝色光点为分割符，将红光与白光分别视作点和划，可以解码出`66253657`或`11708102`。

经过尝试，后者是正确的密码，即明日方舟回声测试微博发布时间20180711的倒写。值得一提的是，在回声测试之中同样也有一场非常有意思的解谜活动，预告了可露希尔的登场。
